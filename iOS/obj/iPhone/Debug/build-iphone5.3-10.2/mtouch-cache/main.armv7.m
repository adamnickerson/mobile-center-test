...
extern void *mono_aot_module_UXDiversArtinaGrialiOS_info;
...
extern void *mono_aot_module_UXDivers_Artina_Grial_info;
...
{
	mono_aot_register_module (mono_aot_module_UXDiversArtinaGrialiOS_info);
	...
	mono_aot_register_module (mono_aot_module_UXDivers_Artina_Grial_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "UXDiversArtinaGrialiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
